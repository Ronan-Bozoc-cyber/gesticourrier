...
<body>
    ...
    <div id="searchModal" class="modal">
        <div class="modal-content">
            ...
            <h2 style="color: green;">🔍 Rechercher un courrier sortant</h2>
            ...
            <button onclick="loadCourrierByNumOrdre()" style="background-color: green; color: white; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer;">Rechercher</button>
        </div>
    </div>
    ...
    <div class="container">
        <div class="form-container" id="form-depart">
            <h2 style="color:green">📤 Information générale d'identification du courrier sortant</h2>
            <form id="courrier-form" action="save_courrier.php" method="post" enctype="multipart/form-data">
                <div class="bordures" style="border: 4px solid #008000;padding: 10px;margin-top: 10px;margin-bottom: 10px;border-radius:10px">
                    <div class="form-control">
                ...
                <h2 style="color:green">🕵️‍♂️ Identification du courrier sortant</h2>
                <div class="bordures" style="border: 4px solid #008000;padding: 10px;margin-top: 10px;margin-bottom: 10px;border-radius:10px">
                    <div class="form-control">
                        ...
                        <input type="text" name="new_expediteur" id="new_expediteur" placeholder="Nouveau destinataire">
                    </div>
                    <div class="form-control">
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" id="courrier_arrive" name="courrier_arrive" placeholder="Sélectionnez un courrier arrivé">
                        <input type="hidden" id="courrier_arrive_id" name="courrier_arrive_id">
                    </div>
                </div>
                <h2 style="color:green">🧾 Association des fichiers (5 maximum & <2Mo)</h2>
                <div class="bordures" style="border: 4px solid #008000;padding: 10px;margin-top: 10px;margin-bottom: 10px;border-radius:10px">
                    <div class="form-control">
                ...
                <div class="form-control">
                    <button type="submit" class="btn" style="background-color:green">Enregistrer Courrier</button>
                </div>
            </form>
        </div>
    </div>
    
    <div class="footer-sortant">
        <p>Liste des courriers sortants <button onclick="openSearchModal()">✏️ Modifier un courrier sortant</button></p>
    </div>
    
    <div class="table-container2">
        <table id="courriers-depart-table" style="font-size: 12px;">
            <thead>
                <tr>
                    <th>N° Ordre</th>
                    <th>Date</th>
                    ...
                    <th>Catégorie</th>
                    <th>Documents</th>
                    <th style="color:orange">N° Ordre<br>Courrier Arrivé</th>
                    <th style="color:orange">Courrier Arrivé</th>
                </tr>
            </thead>
            <tbody>
